...
type Props = {
  formInitialValue: TaskRegistrationFormType;
  onValidateForm: {
  ...
  onSubmit: (form: Required<TaskRegistrationFormType>) => void;
  isLoading: boolean;
  labels: {
    task: {
      title: string;
 ...
 * @author treetips
 */
export const TaskRegistrationForm: VFC<Props> = memo(
